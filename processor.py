...
def detect_silence(
    ...
    cmd = [
        ...
        audio_path,
        "-af",
        f"silencedetect=noise={silence_thresh}dB:d={min_silence_sec}",
        "-f",
        "null",
        "-",
    ]
    ...
    try:
        ...
        logging.error(f"Error running FFmpeg silence detection: {e}")
        return []
...
def process_video(
    ...
    try:
        ...
        original_size = [int(v_stream["width"]), int(v_stream["height"])]
        logging.info(
